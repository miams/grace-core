locals {
  spoke_account_arns = [
    ...
    "${module.tenant_demotest16_prod.root_arn}",
    "${module.tenant_demotest16_mgmt.root_arn}",
    "${module.tenant_demotest16_staging.root_arn}",
    "${module.tenant_demotest16_dev.root_arn}",
    "${module.tenant_demotest17_prod.root_arn}",
